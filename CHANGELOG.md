...
- New: DMG download — drag OPEN BAR into Applications.
- OPEN BAR must be in the Applications folder. If it isn't, it offers to move itself.
- Removed a stray button that could appear in the middle of the screen.
